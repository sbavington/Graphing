...
class Gauge(Widget):
    ...
    file_gauge = StringProperty("Gauge/cadran.png")
    file_needle = StringProperty("Gauge/needle.png")
    size_gauge = BoundedNumericProperty(200, min=128, max=500, errorvalue=128)
